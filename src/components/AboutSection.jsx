...
export default function AboutSection() {
  return (
    <section className="bg-white w-full flex items-center justify-center" id="about">
      <div className="w-full max-w-7xl px-5 py-10 gap-5 grid place-items-center lg:grid-cols-[1fr_0.67fr]">
        <div className="flex flex-col gap-5">
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            ...
            <div className="flex flex-col shadow-lg shadow-primary/50 rounded-md bg-primary text-white p-5 gap-2">
            ...
            <div className="flex flex-col shadow-lg rounded-md p-5 gap-2">
              <span className="font-semibold text-lg text-primary">Values</span>
              <span className="text-black/50 text-xs lg:text-sm">
